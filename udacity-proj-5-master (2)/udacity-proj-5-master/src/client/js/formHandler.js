$(document).ready(function () {
    ...
    const username1 = 'omolara';
      ...
      $(".searchBtn").click(function(event){
        ...
        const ApiKey = "16938869-0980956d31572b5849e9a980b";
          ...
          const pixabayUrl = urlPixabay + "?key=" + ApiKey + "&q=" + searchFinal + "&image_type=photo";
          $.ajax({
                  url: localQueryURL,
                  method: "GET"
              })
  ...
  const postData = () => {
    ...
    fetch('http://localhost:5501/addData',{
        method: "POST",
